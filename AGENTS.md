...
[`.specify/memory/constitution.md`](.specify/memory/constitution.md) is the head of the
document tree: it holds the principles and quality gates, indexes every other document,
and sets out how to resolve conflicts between them. Start there when you need more detail
than this guide gives.
...
- Neo4j 5 cluster for live schema metadata; canonical ArchiMate schema files under
  ...
  `.cache/visualiser` for offline resilience.
