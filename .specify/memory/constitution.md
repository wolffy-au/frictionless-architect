...
- **Rationale**: Consistent behavior keeps users productive and minimizes confusion when switching devices or sharing outputs. Refer to `PROJECT_CONSTITUTION.md` for any domain-specific addenda.
