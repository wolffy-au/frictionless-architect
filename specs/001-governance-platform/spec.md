...
- **FR-006**: System MUST allow human architects to cryptographically sign off on AI-generated ADRs for audit trails.
...
- **FR-016**: System MUST enforce authorization policies using Attribute-Based Access Control (ABAC).
...
- **Critical Business Service (CBS)**: Defined services with mapped technical components and associated impact tolerances.
